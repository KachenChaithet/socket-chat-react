  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div
                className="size-12 rounded-xl bg-secondary/10 flex items-center justify-center 
      ...
      <AuthImagePattern
        ...
        subtitle='Connect with frieds, share moments, and stay in touch with you loved ones.'
      />
    </div>
  )
}
